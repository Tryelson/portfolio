import { Heading, Box, Image, Link, List, ListItem, Flex, Divider } from "@chakra-ui/react";
...
export default function Header(){
    ...
    return (
		<Flex as='header' w='100%' direction='column' justify='space-between' height={'100%'} gap='20px'>			
			<Box>
